...
public class Runigram {
	...
	public static Color[][] flippedHorizontally(Color[][] image) {
		Color [][] flipH = new Color[image.length][image[0].length];
		for(int i = 0 ; i< image.length;i++)
		{
			for(int j=0;j<image[0].length;j++)
			{
				flipH[i][j] = image[i][image[i].length-1-j];
			}
	...
	public static Color[][] flippedVertically(Color[][] image){
		...
		Color [][] flipV = new Color[image.length][image[0].length];
		for(int i = 0 ; i< image[0].length;i++)
		{
			for(int j=0;j<image.length;j++)
			{
				flipV[j][i] = image[image.length-1-j][i];
			}
	...
	public static Color[][] grayScaled(Color[][] image) {
		Color [][] m = new Color[image.length][image[0].length];
		for (int i=0;i<m.length;i++)
		{
			for(int j=0;j<m[0].length;j++)
			{
				m[i][j]= luminance(image[i][j]);
			}
		}
		return m;
	}	
